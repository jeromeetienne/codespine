...
bundled example, [`scripts/benchmarks/project_01_workload.ts`](https://github.com/jeromeetienne/codespine/blob/main/scripts/benchmarks/project_01_workload.ts),
...
- [`/codespine-optimize`](/agent/slash-commands) — the agent that applies an edit, verifies it, and can report its measured impact.
