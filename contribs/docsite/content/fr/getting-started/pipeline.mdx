...
répondent, voir le [guide d'analyse statique](/static-analysis) ; pour chacune en
...
- [Parcourir le graphe](/explore) — utilisez la visualisation interactive pour vous
  repérer dans une base de code inconnue.
- [Guide d'analyse statique](/static-analysis) — utilisez les commandes de requête à la main
  pour répondre à des questions d'impact, de code mort et de dépendances au sujet d'une base de code.
- [Optimiser votre code](/optimize) — la boucle mesurée : profiler, trouver le
