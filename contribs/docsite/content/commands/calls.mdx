...
The outbound counterpart of [`who-calls`](/commands/who-calls).
...
[`who-calls`](/commands/who-calls): same edge kind, opposite direction.
...
- [`who-calls`](/commands/who-calls) — the inbound counterpart (who calls this).
- [`neighbors`](/commands/neighbors) — all one-hop edges, not just `CALLS`.
