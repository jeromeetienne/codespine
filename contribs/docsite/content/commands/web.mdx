...
front-end: [`contribs/web_visualisation`](https://github.com/jeromeetienne/ts_knowledge_graph/tree/main/contribs/web_visualisation)
...
- [`contribs/web_visualisation`](https://github.com/jeromeetienne/ts_knowledge_graph/tree/main/contribs/web_visualisation) — the
