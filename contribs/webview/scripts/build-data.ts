...
const main = (): void => {
	...
	const banner = `${TS_NOCHECK_BANNER}// Generated from the knowledge graph nodes.jsonl and edges.jsonl by scripts/build-data.ts. Do not edit by hand.\n`;
	const sourceScript = source === undefined
		? ''
		: `window.GRAPH_SOURCE = ${JSON.stringify({ github: source })};\n`;
	writeFileSync(outPath, `${banner}${sourceScript}window.GRAPH_DATA = ${JSON.stringify({ nodes, edges })};\n`);
