...
OUT='./.ts_knowledge_graph/project_02'
...
rm -rf ./.ts_knowledge_graph/project_02/graph ./.ts_knowledge_graph/project_02/graph.kuzu ./.ts_knowledge_graph/project_02/prof
